  ...
  return (
    <section className="py-20 bg-transparent overflow-hidden border-y border-white/5">
      ...
      <div className="relative w-full flex overflow-x-hidden">
        <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#030612] to-transparent z-10" />
        <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#030612] to-transparent z-10" />
