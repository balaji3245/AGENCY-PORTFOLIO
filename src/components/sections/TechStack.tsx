...
const technologies = [
  ...
  "GSAP", "Three.js", "Node.js", "GraphQL", "PostgreSQL", "AWS", "Vercel"
];
  ...
  return (
    <section className="py-20 bg-[#050505] overflow-hidden border-y border-white/5">
      <div className="container mx-auto px-6 mb-10 text-center">
         <h2 className="text-xs uppercase tracking-widest text-gray-500">Powered by modern tech</h2>
      </div>
      ...
      <div className="relative w-full flex overflow-x-hidden">
        ...
        >
          ...
          {[...technologies, ...technologies].map((tech, i) => (
            ...
            >
              <span className="text-gray-300 font-medium tracking-wide">{tech}</span>
            </div>
          ))}
        </motion.div>
      </div>
